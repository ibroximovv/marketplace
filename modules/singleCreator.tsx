...
import { CopyIcon, DiscordIcon, GlobeIcon, InstagramIcon, PlusIcon, TwitterIcon, YouToubeIcon } from '@/assets/icons'
...
const SingleCreator: FC<{ singleCreateData: ArtistType, id: string }> = ({ singleCreateData, id }) => {
    ...
    const links = [<GlobeIcon />, <DiscordIcon />, <YouToubeIcon />, <TwitterIcon />, <InstagramIcon />]
    function handleCopy() {
            ...
            <div className='containers'>
                ...
                <div className='!mb-[40px] flex justify-between'>
                    ...
                    <div className='flex gap-[20px] self-start'>
                        <Button onClick={() => handleCopy()} variant='filled' type='button' icon={<CopyIcon />} iconPosition='left' title={shortenId(id)} />
                        <Button variant='outlined' type='button' icon={<PlusIcon />} iconPosition='left' title={'Follow'} />
                    </div>
                </div>
                <div className='flex'>
