...
const MagicMushrooms = () => {
    ...
    return (
        <section style={{ backgroundImage: 'url("/meduza1.svg")', backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundAttachment:"fixed" }} className="h-[660px] flex justify-end pb-[60px] overflow-hidden">
