                ...
                <div className="flex items-center justify-around">
                    <div className="w-[330px] h-[439px] flex flex-col items-center bg-[#3B3B3B] rounded-[20px]">
                        <div className="w-[250px] h-[250px]">
                            <Image className="w-[250px] h-[250px]" src={'/wallet.svg'} alt="Learn Img" width={250} height={250} priority />
                        </div>
                    ...
                    <div className="w-[330px] h-[439px] flex flex-col items-center bg-[#3B3B3B] rounded-[20px]">
                        <div className="w-[250px] h-[250px]">
                            <Image className="w-[250px] h-[250px]" src={'/collection.svg'} alt="Learn Img" width={250} height={250} priority />
                        </div>
                        <strong className="mt-[20px] text-[22px] font-semibold text-center">
                            Create Collection
                        </strong>
                    ...
                    <div className="w-[330px] h-[439px] flex flex-col items-center bg-[#3B3B3B] rounded-[20px]">
                        <div className="w-[250px] h-[250px]">
                            <Image className="w-[250px] h-[250px]" src={'/earn.svg'} alt="Learn Img" width={250} height={250} priority />
                        </div>
                        <strong className="mt-[20px] text-[22px] font-semibold text-center">
                            Start Earning
                        </strong>
